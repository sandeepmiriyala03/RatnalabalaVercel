...
    icon: <User size={20} />,
    label: "పిల్లలు",
    value: "రమణీయ సుధారాణి , కమనీయ సుధాఫణి , శ్రీధర్"
  }
];
...
  "1960: హైదరాబాద్ అఖిల భారత తెలుగు రచయితల సభలో కృష్ణశాస్త్రి, సి.నారాయణరెడ్డిగారి పరిచయం.",
...
  "1965 ఆగష్టం 17:న జోశ్యుల నరసింహారావు, సీతాదేవిల ప్రథమ కుమార్తె 'లక్ష్మీదేవి'తో వివాహం.",
...
  "1977 డిసెంబర్ 20: థీసిస్ సబ్మిట్.",
...
  "1995: శ్రీ గొడవర్తి సత్యమూర్తి పక్షపత్రిక ‘గీతాంజలి’ సంపాదకత్వ బాధ్యతలు.",
...
  "1986 - శ్రీశ్రీ గారితో నా అనుబంధం",
...
  `మిరియాల రామకృష్ణ శ్రీశ్రీ సాహిత్యంపై పరిశోధన చేసి డాక్టరేట్ సాధించారు.ఈ పుస్తకంపై ఆంధ్రజ్యోతి పత్రికలో పురాణం సుబ్రహ్మణ్య శర్మ 
  "శ్రీశ్రీకి మిరియాల కషాయం" పేరుతో ఏడు వారాల సీరియల్ విమర్శలు రాశారు. 
  మహాప్రస్థానంలోని పదాలకు సరిపడని వ్యాఖ్యానాలు,లేని సారస్వాలు లాగుతూ రాశారని విమర్శ". 
  రామకృష్ణకు ఈ రచనకు డాక్టరేట్ వచ్చినప్పుడు శ్రీశ్రీ "డియర్ డాక్టర్ రామకృష్ణా! హార్టీ కంగ్రాచ్యులేషన్స్.
   యువర్స్ పేషెంట్లీ శ్రీశ్రీ" అంటూ సందేశం పంపి చమత్కరించారు.`,
];
...
const authorInfo = [
  `మిరియాల రామకృష్ణ తెలుగు రచయిత, పరిశోధకుడు. ఇతను సుమారు 36 సంవత్సరాలు విద్యాశాఖలో తెలుగు భాషా సాహిత్యాలు బోధిస్తూ, మహాకవి శ్రీశ్రీ రచనలపై పరిశోధన చేశారు. కొంతమంది పరిశోధన అతిగా సాగిందని విమర్శించారు.`,
  `ఇతను రచించిన కథల్లో ఆకుపచ్చని కుక్కపిల్ల, ఆశ్చర్య చూడామణి, చెరసాలలో సరస్వతి, ఉంగరం వంటి గొప్ప కథలు ఉన్నాయి.`,
  `కథలతో పాటు పద్యాలు, వచన కవితలు, గేయాలు, వ్యాసాలు, బాలసాహిత్యం విస్తృతంగా వ్రాసారు.`,
